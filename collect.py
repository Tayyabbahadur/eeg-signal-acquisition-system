...
import time
import datetime  
COM_PORT = '/dev/cu.usbmodem142301'  # Replace with your Arduino's COM port
...
with open('tayyab.csv', 'a', newline='') as csvfile:
    csvwriter = csv.writer(csvfile)

    # Set the maximum duration of the data collection (in seconds) 704997
    max_duration = 1800
